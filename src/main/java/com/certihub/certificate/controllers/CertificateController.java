...
public class CertificateController {
    ...
    public List<Certificate> searchCertificates(
            @RequestParam Optional<String> certificateName,
            @RequestParam Optional<String> issuer,
            @RequestParam Optional<String> category,
            @RequestParam Optional<LocalDate> issueDateFrom,
            @RequestParam Optional<LocalDate> issueDateTo
    ) {
        return certificateService.searchCertificates(certificateName, issuer, category, issueDateFrom, issueDateTo);
    }
